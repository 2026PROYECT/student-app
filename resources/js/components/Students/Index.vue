        ...
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="divide-y divide-gray-50">
            <tr v-for="student in students.data" :key="student.id" class="hover:bg-indigo-50/30 transition">
              ...
              <td class="px-6 py-5 text-sm text-gray-600">{{ student.email }}</td>
              <td class="px-6 py-5">
                <span class="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-xs font-bold mr-2">{{ student.career }}</span>
